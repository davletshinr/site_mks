...
(function($) {
    ...
    $.fn.orbit = function(options) {
        ...
        var defaults = {  
            ...
            advanceSpeed: 1, //if auto advance is enabled, time between transitions 
            startClockOnMouseOut: true, //if clock should start on MouseOut
            startClockOnMouseOutAfter: 1, //how long after mouseout timer should start again
            directionalNav: true, //manual advancing directional navs
            captions: true, //do you want captions?
            captionAnimationSpeed: 1, //if so how quickly should they animate in
